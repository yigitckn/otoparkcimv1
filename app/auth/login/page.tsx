    ...
    <div className="min-h-screen flex">
            ...
            <div className="finale mb-5">
              <div className="flex items-center gap-4">
                ...
                <svg width="40" height="40" viewBox="0 0 40 40" className="opacity-95">
                  <circle cx="20" cy="20" r="18" fill="#2f7ff5"/>
      ...
      <div className="w-full lg:w-[47%] bg-[#0b1220] flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-[360px]">
          ...
          {/* Başlık */}
          <h1 className="text-[26px] font-bold text-white tracking-tight mb-1">Hoşgeldiniz</h1>
          <p className="text-sm text-white/60 mb-7">Hesabınıza giriş yapın</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-[#2f7ff5] to-[#5ea3ff] text-white text-sm font-semibold rounded-lg hover:opacity-90 disabled:opacity-50 shadow-lg shadow-blue-500/30 transition-all mt-6"
            >
          ...
          <p className="text-center text-sm text-white/60 mt-5">
            Hesabınız yok mu?{' '}
            <Link href="/auth/register" className="text-[#5ea3ff] font-semibold hover:underline">
              Kayıt Ol
            </Link>
          </p>
        </div>
